...
class IdmapLDAPModel(sa.Model):
    ...
    idmap_ldap_ldap_model_dn = sa.Column(sa.String(120))
    ...
    idmap_ldap_certificate_id = sa.Column(sa.ForeignKey('system_certificate__old.id'), index=True, nullable=True)
...
class IdmapRFC2307Model(sa.Model):
    ...
    idmap_rfc2307_certificate_id = sa.Column(sa.ForeignKey('system_certificate__old.id'), index=True, nullable=True)
